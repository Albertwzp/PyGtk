...
class PyApp(gtk.Window):
    ...
    def load_pixbufs(self):
        try:
            self.mutp = gtk.gdk.pixbuf_new_from_file("/root/Downloads/ab.jpg")
            self.mitp = gtk.gdk.pixbuf_new_from_file("/root/Downloads/lt.jpg")
            self.medp = gtk.gdk.pixbuf_new_from_file("/root/Downloads/lye.jpg")
            self.maxp = gtk.gdk.pixbuf_new_from_file("/root/Downloads/ly.jpg")
        except Exception, e:
